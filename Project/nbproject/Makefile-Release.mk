...
${OBJECTDIR}/Case_Entier.o: Case_Entier.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Case_Entier.o Case_Entier.cpp

${OBJECTDIR}/Case_Vide.o: Case_Vide.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Case_Vide.o Case_Vide.cpp

${OBJECTDIR}/Grille.o: Grille.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Grille.o Grille.cpp

${OBJECTDIR}/Grille_2048.o: Grille_2048.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Grille_2048.o Grille_2048.cpp

${OBJECTDIR}/Grille_2048_VarN.o: Grille_2048_VarN.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Grille_2048_VarN.o Grille_2048_VarN.cpp

${OBJECTDIR}/Grille_2048_VarT.o: Grille_2048_VarT.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Grille_2048_VarT.o Grille_2048_VarT.cpp

${OBJECTDIR}/Grille_Taquin.o: Grille_Taquin.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Grille_Taquin.o Grille_Taquin.cpp
...
${OBJECTDIR}/JoueurHumain.o: JoueurHumain.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/JoueurHumain.o JoueurHumain.cpp

${OBJECTDIR}/JoueurRobot.o: JoueurRobot.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/JoueurRobot.o JoueurRobot.cpp

${OBJECTDIR}/TCase.o: TCase.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TCase.o TCase.cpp

${OBJECTDIR}/run.o: run.cc
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/run.o run.cc
